...
import { addToViewlist, removeFromViewlist } from "../actions/viewlistActions";
...
function ProductPage() {
  ...
  return isLoading ? (
    ...
    <Box className={classes.component}>
        ...
        <Grid container className={classes.container}>
          ...
          >
            ...
            <Box style={{ display: "flex", alignItems: "center" }}>
              ...
              <span>
                <img src={fassured} style={{ height: 21, marginLeft: 10 }} alt={product.title.shortTitle} />
              </span>
            </Box>
            <Typography>
      ...
      <RecommendedItems title={"Similar Items"} categoryName={product.subCategory} />
    </Box>
  );
}
